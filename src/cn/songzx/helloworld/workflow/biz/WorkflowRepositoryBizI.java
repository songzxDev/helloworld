/**
* @Title: WorkflowRepositoryBizI.java
* @Package cn.songzx.helloworld.workflow.biz
* @Description: TODO(用一句话描述该文件做什么)
* @author Songzx songzx_2326@163.com
* @date 2017年10月19日 上午9:34:08
* @version V1.0
*/
package cn.songzx.helloworld.workflow.biz;
...
/**
 * @ClassName: WorkflowRepositoryBizI
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author Songzx songzx_2326@163.com
 * @date 2017年10月19日 上午9:34:08
 *
 */
public interface WorkflowRepositoryBizI {
	...
	/**
	 * Similar to
	 * {@link #activateProcessDefinitionByKey(String, boolean, Date)}, but only
	 * applicable for the given tenant identifier.
	 */
